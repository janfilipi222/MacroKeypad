...
class AddProfilePopup(QDialog):
    add_profile = Signal(dict)
    ...
    def __init__(self, parent=None):
        ...
        # Flag pro sledování, zda už uživatel ručně zasáhl do ID pole
        self._user_edited_id = False

        # Skrytí rámce okna a zapnutí průhlednosti pro samotné okno dialogu
        ...
        # Spodní tlačítka (Add Profile, Cancel)
    ...
    def eventFilter(self, obj, event):
        # Detekce kliknutí / zaměření mysí do id_input
