...
class ProfileSettingsPopup(QDialog):
    save_profile = Signal(dict)
    ...
    def __init__(self, parent=None):
        ...
        self.id_input.setPlaceholderText("Enter custom profile ID...")
    ...
    def set_data(self, profile):
        ...
        self.name_input.setText(getattr(profile, "name", ""))
        self.id_input.setText(getattr(profile, "id", ""))
        
        # Ošetření cesty / aplikací
        path = getattr(profile, "application", getattr(profile, "path", ""))
    ...
    def _on_name_changed(self, text: str):
        if self._user_edited_id:
            return
        ignored_words = {"view", "profile", "screen"}
    ...
    def _handle_save(self):
        ...
        self.save_profile.emit(data)
        self.accept()

    def _handle_delete(self):
        profile_id = self.id_input.text().strip()
        self.delete_profile.emit(profile_id)
        self.accept()